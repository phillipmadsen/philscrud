...
class FormFieldsGenerator
{
    ...
    public static function textarea($templateData, $field)
    {
        ...
        $textareaField .= "\n\t{!! Form::textarea('\$FIELD_NAME\$', null, ['class' => 'form-control \$FIELD_NAME\$-textarea', 'rows' => '3']) !!}";
    ...
    public static function password($templateData, $field)
    {
        ...
        $textField .= "\n\t{!! Form::password('\$FIELD_NAME\$', ['class' => 'form-control \$FIELD_NAME\$-text']) !!}";
    ...
    public static function email($templateData, $field)
    {
        ...
        $textField .= "\n\t{!! Form::email('\$FIELD_NAME\$', null, ['class' => 'form-control \$FIELD_NAME\$-email']) !!}";
        $templateData = str_replace('$FIELD_INPUT$', $textField, $templateData);
    ...
    public static function checkbox($templateData, $field)
    {
        ...
        $textField .= "{!! Form::checkbox('\$FIELD_NAME\$', 1, false) !!}";
    ...
    public static function number($templateData, $field)
    {
        ...
        $textField .= "\n\t{!! Form::number('\$FIELD_NAME\$', null, ['class' => 'form-control \$FIELD_NAME\$-number']) !!}";
        $templateData = str_replace('$FIELD_INPUT$', $textField, $templateData);
    ...
    public static function date($templateData, $field)
    {
        ...
        $textField .= "\n\t{!! Form::date('\$FIELD_NAME\$', null, ['class' => 'form-control \$FIELD_NAME\$-date_format()']) !!}";
        $templateData = str_replace('$FIELD_INPUT$', $textField, $templateData);
    ...
    public static function select($templateData, $field)
    {
        ...
        $textField .= "\n\t{!! Form::select('\$FIELD_NAME\$', \$INPUT_ARR\$, null, ['class' => 'form-control \$FIELD_NAME\$-select']) !!}";
        $textField = str_replace('$FIELD_NAME$', $field['fieldName'], $textField);
