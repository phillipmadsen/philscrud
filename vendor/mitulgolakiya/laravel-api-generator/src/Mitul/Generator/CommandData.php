    ...
    class CommandData
    {
        ...
        public static function getConfigDynamicVariables()
        {
            return [
                ...
                '$NAMESPACE_ADMIN_REQUEST$'    => Config::get('generator.namespace_admin_request', 'App\Http\Requests\Admin'),
                '$NAMESPACE_REPOSITORY$'       => Config::get('generator.namespace_repository', 'App\Libraries\Repositories'),
                '$NAMESPACE_ADMIN_REPOSITORY$' => Config::get('generator.namespace_admin_repository', 'App\Libraries\Repositories\Admin'),
                '$NAMESPACE_MODEL$'            => Config::get('generator.namespace_model', 'App\Models'),
                '$NAMESPACE_ADMIN_MODEL$'      => Config::get('generator.namespace_admin_model', 'App\Models\Admin'),
                '$NAMESPACE_LIVE_MODEL$'       => Config::get('generator.namespace_live_model', 'App\Models'),
