...
class AdminModelGenerator implements GeneratorProvider
{
    /** @var  CommandData */
    private $commandData;
    ...
    public function __construct($commandData)
    {
        ...
        $this->path = Config::get('generator.path_admin_model', app_path('Models/Admin/'));
    }

    public function generate()
    {
        $templateName = 'AdminModel';

        $templateData = $this->commandData->templatesHelper->getTemplate($templateName, 'common/admin');
